...
const elementsData = [
  ...
  { number: 57, symbol: 'La', name: 'Lantânio', category: 'lantanideo', atomic_mass: 138.91, electron_configuration: '[Xe] 5d¹ 6s²', group: 4, period: 9, block: 'f', discovery_year: 1839, state_at_room_temp: 'sólido', description: 'Primeiro elemento da série dos lantanídeos. Usado em baterias de hidreto metálico e óptica.' },
  { number: 58, symbol: 'Ce', name: 'Cério', category: 'lantanideo', atomic_mass: 140.12, electron_configuration: '[Xe] 4f¹ 5d¹ 6s²', group: 5, period: 9, block: 'f', discovery_year: 1803, state_at_room_temp: 'sólido', description: 'Lantanídeo mais abundante. Usado em catalisadores e pedras de isqueiro.' },
  { number: 59, symbol: 'Pr', name: 'Praseodímio', category: 'lantanideo', atomic_mass: 140.91, electron_configuration: '[Xe] 4f³ 6s²', group: 6, period: 9, block: 'f', discovery_year: 1885, state_at_room_temp: 'sólido', description: 'Lantanídeo usado em ímãs fortes e vidros especiais para óculos de proteção.' },
  { number: 60, symbol: 'Nd', name: 'Neodímio', category: 'lantanideo', atomic_mass: 144.24, electron_configuration: '[Xe] 4f⁴ 6s²', group: 7, period: 9, block: 'f', discovery_year: 1885, state_at_room_temp: 'sólido', description: 'Lantanídeo usado na fabricação dos ímãs permanentes mais fortes conhecidos.' },
  { number: 61, symbol: 'Pm', name: 'Promécio', category: 'lantanideo', atomic_mass: 145, electron_configuration: '[Xe] 4f⁵ 6s²', group: 8, period: 9, block: 'f', discovery_year: 1945, state_at_room_temp: 'sólido', description: 'Elemento radioativo sintético. Usado em baterias nucleares miniaturizadas.' },
  { number: 62, symbol: 'Sm', name: 'Samário', category: 'lantanideo', atomic_mass: 150.36, electron_configuration: '[Xe] 4f⁶ 6s²', group: 9, period: 9, block: 'f', discovery_year: 1879, state_at_room_temp: 'sólido', description: 'Lantanídeo usado em ímãs, lasers e controle de reatores nucleares.' },
  { number: 63, symbol: 'Eu', name: 'Európio', category: 'lantanideo', atomic_mass: 151.96, electron_configuration: '[Xe] 4f⁷ 6s²', group: 10, period: 9, block: 'f', discovery_year: 1901, state_at_room_temp: 'sólido', description: 'Lantanídeo altamente reativo. Usado em telas de TV e iluminação fluorescente.' },
  { number: 64, symbol: 'Gd', name: 'Gadolínio', category: 'lantanideo', atomic_mass: 157.25, electron_configuration: '[Xe] 4f⁷ 5d¹ 6s²', group: 11, period: 9, block: 'f', discovery_year: 1880, state_at_room_temp: 'sólido', description: 'Lantanídeo ferromagnético à temperatura ambiente. Usado em agentes de contraste para ressonância magnética.' },
  { number: 65, symbol: 'Tb', name: 'Térbio', category: 'lantanideo', atomic_mass: 158.93, electron_configuration: '[Xe] 4f⁹ 6s²', group: 12, period: 9, block: 'f', discovery_year: 1843, state_at_room_temp: 'sólido', description: 'Lantanídeo usado em telas de alta tecnologia e lâmpadas de baixo consumo.' },
  { number: 66, symbol: 'Dy', name: 'Disprósio', category: 'lantanideo', atomic_mass: 162.50, electron_configuration: '[Xe] 4f¹⁰ 6s²', group: 13, period: 9, block: 'f', discovery_year: 1886, state_at_room_temp: 'sólido', description: 'Lantanídeo com fortes propriedades magnéticas. Usado em discos rígidos e veículos híbridos.' },
  { number: 67, symbol: 'Ho', name: 'Hólmio', category: 'lantanideo', atomic_mass: 164.93, electron_configuration: '[Xe] 4f¹¹ 6s²', group: 14, period: 9, block: 'f', discovery_year: 1878, state_at_room_temp: 'sólido', description: 'Lantanídeo com o magnetismo mais forte entre os elementos naturais. Usado em lasers médicos.' },
  { number: 68, symbol: 'Er', name: 'Érbio', category: 'lantanideo', atomic_mass: 167.26, electron_configuration: '[Xe] 4f¹² 6s²', group: 15, period: 9, block: 'f', discovery_year: 1842, state_at_room_temp: 'sólido', description: 'Lantanídeo usado em fibras ópticas e lasers para cirurgia dermatológica.' },
  { number: 69, symbol: 'Tm', name: 'Túlio', category: 'lantanideo', atomic_mass: 168.93, electron_configuration: '[Xe] 4f¹³ 6s²', group: 16, period: 9, block: 'f', discovery_year: 1879, state_at_room_temp: 'sólido', description: 'Lantanídeo raro usado em equipamentos de raios-X portáteis e lasers médicos.' },
  { number: 70, symbol: 'Yb', name: 'Itérbio', category: 'lantanideo', atomic_mass: 173.05, electron_configuration: '[Xe] 4f¹⁴ 6s²', group: 17, period: 9, block: 'f', discovery_year: 1878, state_at_room_temp: 'sólido', description: 'Lantanídeo usado em relógios atômicos e aços especiais. Tem propriedades semelhantes ao cálcio.' },
  { number: 71, symbol: 'Lu', name: 'Lutécio', category: 'lantanideo', atomic_mass: 174.97, electron_configuration: '[Xe] 4f¹⁴ 5d¹ 6s²', group: 18, period: 9, block: 'd', discovery_year: 1907, state_at_room_temp: 'sólido', description: 'Último elemento da série dos lantanídeos. Usado em catalisadores para refinarias de petróleo.' },
  ...
  { number: 89, symbol: 'Ac', name: 'Actínio', category: 'actinideo', atomic_mass: 227, electron_configuration: '[Rn] 6d¹ 7s²', group: 4, period: 10, block: 'f', discovery_year: 1899, state_at_room_temp: 'sólido', description: 'Elemento radioativo que dá nome à série dos actinídeos. Brilha no escuro com luz azul.' },
  { number: 90, symbol: 'Th', name: 'Tório', category: 'actinideo', atomic_mass: 232.04, electron_configuration: '[Rn] 6d² 7s²', group: 5, period: 10, block: 'f', discovery_year: 1829, state_at_room_temp: 'sólido', description: 'Metal radioativo usado como combustível alternativo em reatores nucleares.' },
  { number: 91, symbol: 'Pa', name: 'Protactínio', category: 'actinideo', atomic_mass: 231.04, electron_configuration: '[Rn] 5f² 6d¹ 7s²', group: 6, period: 10, block: 'f', discovery_year: 1913, state_at_room_temp: 'sólido', description: 'Elemento radioativo raro. Subproduto do decaimento do urânio e tório.' },
  { number: 92, symbol: 'U', name: 'Urânio', category: 'actinideo', atomic_mass: 238.03, electron_configuration: '[Rn] 5f³ 6d¹ 7s²', group: 7, period: 10, block: 'f', discovery_year: 1789, state_at_room_temp: 'sólido', description: 'Elemento radioativo usado para geração de energia nuclear e armas.' },
  { number: 93, symbol: 'Np', name: 'Neptúnio', category: 'actinideo', atomic_mass: 237, electron_configuration: '[Rn] 5f⁴ 6d¹ 7s²', group: 8, period: 10, block: 'f', discovery_year: 1940, state_at_room_temp: 'sólido', description: 'Primeiro elemento transurânico a ser sintetizado. Subproduto de reatores nucleares.' },
  { number: 94, symbol: 'Pu', name: 'Plutônio', category: 'actinideo', atomic_mass: 244, electron_configuration: '[Rn] 5f⁶ 7s²', group: 9, period: 10, block: 'f', discovery_year: 1940, state_at_room_temp: 'sólido', description: 'Elemento radioativo usado em armas nucleares e sondas espaciais.' },
  { number: 95, symbol: 'Am', name: 'Amerício', category: 'actinideo', atomic_mass: 243, electron_configuration: '[Rn] 5f⁷ 7s²', group: 10, period: 10, block: 'f', discovery_year: 1944, state_at_room_temp: 'sólido', description: 'Elemento radioativo usado em detectores de fumaça e medição de espessura.' },
  { number: 96, symbol: 'Cm', name: 'Cúrio', category: 'actinideo', atomic_mass: 247, electron_configuration: '[Rn] 5f⁷ 6d¹ 7s²', group: 11, period: 10, block: 'f', discovery_year: 1944, state_at_room_temp: 'sólido', description: 'Elemento radioativo com alta emissão de radiação e calor. Usado em geradores termoelétricos.' },
  { number: 97, symbol: 'Bk', name: 'Berquélio', category: 'actinideo', atomic_mass: 247, electron_configuration: '[Rn] 5f⁹ 7s²', group: 12, period: 10, block: 'f', discovery_year: 1949, state_at_room_temp: 'sólido', description: 'Elemento sintético radioativo com poucos usos práticos além da pesquisa científica.' },
  { number: 98, symbol: 'Cf', name: 'Califórnio', category: 'actinideo', atomic_mass: 251, electron_configuration: '[Rn] 5f¹⁰ 7s²', group: 13, period: 10, block: 'f', discovery_year: 1950, state_at_room_temp: 'sólido', description: 'Elemento radioativo usado como fonte de nêutrons para detecção de ouro e prata em minérios.' },
  { number: 99, symbol: 'Es', name: 'Einstênio', category: 'actinideo', atomic_mass: 252, electron_configuration: '[Rn] 5f¹¹ 7s²', group: 14, period: 10, block: 'f', discovery_year: 1952, state_at_room_temp: 'sólido', description: 'Elemento sintético radioativo criado nos resíduos da primeira bomba de hidrogênio.' },
  { number: 100, symbol: 'Fm', name: 'Férmio', category: 'actinideo', atomic_mass: 257, electron_configuration: '[Rn] 5f¹² 7s²', group: 15, period: 10, block: 'f', discovery_year: 1952, state_at_room_temp: 'sólido', description: 'Elemento radioativo sintético com meia-vida curta. Descoberto em resíduos de teste nuclear.' },
  { number: 101, symbol: 'Md', name: 'Mendelévio', category: 'actinideo', atomic_mass: 258, electron_configuration: '[Rn] 5f¹³ 7s²', group: 16, period: 10, block: 'f', discovery_year: 1955, state_at_room_temp: 'sólido', description: 'Elemento sintético radioativo. Primeiro elemento criado átomo por átomo.' },
  { number: 102, symbol: 'No', name: 'Nobélio', category: 'actinideo', atomic_mass: 259, electron_configuration: '[Rn] 5f¹⁴ 7s²', group: 17, period: 10, block: 'f', discovery_year: 1958, state_at_room_temp: 'sólido', description: 'Elemento radioativo sintético extremamente instável. Nomeado em homenagem a Alfred Nobel.' },
  { number: 103, symbol: 'Lr', name: 'Laurêncio', category: 'actinideo', atomic_mass: 266, electron_configuration: '[Rn] 5f¹⁴ 7s² 7p¹', group: 18, period: 10, block: 'd', discovery_year: 1961, state_at_room_temp: 'sólido', description: 'Último elemento da série dos actinídeos. Extremamente radioativo e de vida curta.' },
